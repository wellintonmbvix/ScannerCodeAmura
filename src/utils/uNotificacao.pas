...
class procedure TLoadingNotificate.Hide;
begin
...
class procedure TLoadingNotificate.Show(const Frm : Tform; const msg: string);
var
...
begin
  ...
  Mensagem.StyledSettings         := [TStyledSetting.Family,
...
class procedure TLoadingNotificate.DeleteToast(Sender: TObject);
begin
...
class procedure TLoadingNotificate.ToastMessage(const Frm : Tform; const msg: string;
                                      alinhamento: TAlignLayout = TAlignLayout.Bottom;
                                      cor_fundo: Cardinal = $FF22AF70;
                                      cor_fonte: Cardinal = $FFFFFFFF;
                                      duracao: integer = 4);
...
begin
  ...
  AnimacaoToast.OnFinish      := TLoadingNotificate.DeleteToast;
